...
import { assets, dummyAddress } from '../assets/greencart_assets/assets.js';
...
const Cart = () => {
    ...
    const {products, currency, cartItems, removeCartItem, getCartCount,
        updatedCartItem, navigate, getCartAmount,
     } = useAppContext()
       ...
       (
        ...
        <div className="flex flex-col md:flex-row mt-16">
                ...
                <h1 className="text-3xl font-medium mb-6">
                    ...
                    <div className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 text-base font-medium pb-3">
                        ...
                        <div className="flex items-center md:gap-6 gap-3">
                            ...
                            <div onClick={() => {navigate (`/products/ ${products.category.toLowerCase()}/${product._id}`);
                                   scroll(0,0)} }
                                   className="cursor-pointer w-24 h-24 flex items-center justify-center border border-gray-300 rounded">
                                <img className="max-w-full h-full object-cover" src=
                                {product.image[0]} alt={product.name} />
                            </div>
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onClick={e => updatedCartItem(product._id, number(e.target.value))} 
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                            ...
                            <div className="absolute top-12 py-1 bg-white border
                             border-gray-300 text-sm w-full">
                               { address.map((address, index) =>( 
                                <p onClick={() => { setSelectedAddresses(address); 
                ...
                <button 
                onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-indigo-500 text-white font-medium hover:bg-indigo-600 transition">
