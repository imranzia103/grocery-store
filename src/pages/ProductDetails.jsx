    ...
    product && (
        <div className=" mt-12">
            <p>
                ...
                <span className="text-primary/10"> {products.name}</span>
            </p>
...
<div  className=" flex flex-col items-center  mt-16">
    <div className=" flex flex-col items-center w-max">
        ...
        gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full">
            {relatedProducts.filter((products) => products.inStock).map
            ((products, index) => (
        ...
        text-primary hover:bg-primary/10 transition" > See More
