...
const MainBanner = () => {
  return (
    <div className="ralative">
      ...
      <div
        className=" absolute inset-0 flex flex-col items-center md:items-start
      justify-end md:justify-center pb-24 md:pb-65 px-4 md:pl-40 lg:pl-55"
      >
        <h1
        ...
        <div className=" flex items-center mt-6 font-medium">
          <Link
            to={"/products"}
            className=" group flex items-center gap-2 bg-primary  px-7 md:px-9 py-3 
