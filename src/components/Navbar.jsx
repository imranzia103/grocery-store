...
const Navbar = () => {
  ...
  return (
    <nav
      className="flex items-center justify-between px-4 md:px-14 
    lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all"
    >
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300
         px-3 rounded-full">
          <input
        ...
        {!user ? (
          ...
          <div className=" relative group">
            ...
            border border-gray-300 py-2 w-30 rounded-b-md text-sm z-40"
            >
              <li
